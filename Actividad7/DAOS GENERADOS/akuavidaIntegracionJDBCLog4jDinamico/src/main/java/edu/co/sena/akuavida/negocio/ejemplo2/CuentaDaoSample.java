...
public class CuentaDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereUsusarioIdususarioEquals("");
            ...
            cuenta1.setNumeroDocumento("1023014978");
            cuenta1.setPrimerNombre("Pepito");
            cuenta1.setSegundoNombre("Benio");
            cuenta1.setPrimerApellido("Gonzales");
            cuenta1.setSegundoApellido("Penuela");
            cuenta1.setContrasena("123456");
            cuenta1.setCorreo("pepitobonito@hotmail.com");
            cuenta1.setDireccion("Donde siempre");
            cuenta1.setTelefono("7612288");
            cuenta1.setRool("Cliente");
            cuenta1.setActivo(new Short("1"));
            cuenta1.setUsusarioIdususario("001");
            
            CuentaDao cuentaDao=getCuentaDao();
            cuentaDao.insert(cuenta1);
            System.out.println("Se inserto la cuenta");
            cuenta1.setTelefono("4567891");
            cuenta1.setDireccion("Esta es otra");
            cuentaDao.update(cuenta1.createPk(), cuenta1);
