...
public class PedidoDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        ped1.setFacturaIdFactura(112);
        ped1.setFecha(fechaActual);
        ped1.setSubtotal(0);
        ped1.setTotal(0);
        
        PedidoDao pedDao=getPedidoDao();
        pedDao.insert(ped1);
        System.out.println("Se inserto el pedido");
        ped1.setSubtotal(1350000);
        ped1.setTotal(13500000);
        pedDao.update(ped1.createPk(), ped1);
