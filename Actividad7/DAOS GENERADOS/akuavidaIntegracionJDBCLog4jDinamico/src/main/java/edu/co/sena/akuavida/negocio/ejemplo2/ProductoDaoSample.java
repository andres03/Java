...
public class ProductoDaoSample {
    ...
    public static void main(String[] arg) throws Exception {
        ...
        producto1.setNombre("Purificador fresita");
        producto1.setPrecio(170000);
        producto1.setDescripcion("Super purificador 1000 ultima generacion");
        producto1.setCantidad(20);
        producto1.setActivo(new Short("1"));
        producto1.setImpuesto(16);
        producto1.setCategoriasIdCategoria(1);
        
        ProductoDao proDao=getProductoDao();
       proDao.insert(producto1);
        System.out.println("Se inserto un producto");
        
        producto1.setNombre("Purificador All Star");
        producto1.setPrecio(160000);        
        proDao.update(producto1.createPk(), producto1);
