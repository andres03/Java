...
public class InventarioDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereFechaDeCompraEquals(null);
            ...
            inv1.setCantidad(6);
            inv1.setProductoIdProducto("01");
            inv1.setCantidadProductoComprado(4568);
            inv1.setFechaDeCompra(fechaActual);
            
            InventarioDao invDao=getInventarioDao();
           // invDao.insert(inv1);
            System.out.println("Se inserto el inventario");
            inv1.setCantidad(45);
            invDao.update(inv1.createPk(), inv1);
