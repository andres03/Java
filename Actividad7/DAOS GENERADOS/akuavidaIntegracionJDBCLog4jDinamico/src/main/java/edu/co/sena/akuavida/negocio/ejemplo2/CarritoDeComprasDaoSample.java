...
public class CarritoDeComprasDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereSubtotalEquals(0);
            CarritoDeCompras cc1= new CarritoDeCompras();
            cc1.setIdCarrito("123fghjk78");
            cc1.setTotal(0);
            cc1.setSubtotal(0);
            
            CarritoDeComprasDao ccDao=getCarritoDeComprasDao();
            ccDao.insert(cc1);
            System.out.println("Se inserto el carrito de compras");
            cc1.setSubtotal(123456);
            cc1.setTotal(1600000);
            ccDao.update(cc1.createPk(), cc1);
            System.out.println("Se actualizo el carrito de compras");
            findAll();
	}
