...
public class UsusarioDaoSample
{
	...
	public static void main(String[] arg) throws Exception
	{
		...
		// findWhereEstadoEquals("");
            Ususario usu1= new Ususario();
            usu1.setIdUsusario("001");
            usu1.setPassword("123456");
            usu1.setRol("Cliente");
            usu1.setEstado("Activo");
            
            
            UsusarioDao usuDao = getUsusarioDao();
            usuDao.insert(usu1);
            System.out.println("Se inseto el Usuario");
            usu1.setPassword("123456789");
            usuDao.update(usu1.createPk(), usu1);
